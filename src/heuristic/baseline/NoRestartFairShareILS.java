...
public class NoRestartFairShareILS extends ExtendedHyperHeuristic {
	...
	//heuristics.FairShareILS using default parameter settings
	public NoRestartFairShareILS(long seed) {
		super(seed);
	}
	
	//heuristics.FairShareILS using temperature T
	...
	public String toString() {
		return "heuristics.NoRestartFairShareILS(T:"+T+")";
	}
